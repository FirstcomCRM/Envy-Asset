        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered container-items">
              <thead>
                ...
                <th style="width:15%">Unrealized Trading Currency</th>
              ...
              <tr class="item">
                    ...
                    <td>
                      <?= $form->field($line, "[{$i}]month")->textInput(['maxlength' => true])->label(false) ?>
                    </td>
                    ...
                    <td>
                      <?= $form->field($line, "[{$i}]month_price")->textInput(['maxlength' => true])->label(false) ?>
