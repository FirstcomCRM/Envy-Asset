...
class ProductTypeController extends Controller
{
    ...
    public function behaviors()
    {
      ...
      foreach ( $userGroupArray as $uGId => $uGName ){
          $permission = UserPermission::find()->where(['controller' => 'ProductType'])->andWhere(['user_group_id' => $uGId ] )->all();
          $actionArray = [];
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', "Product Type has been updated");
            return $this->redirect(['view', 'id' => $model->id]);
        } else {
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', "Product Type has been deleted");
