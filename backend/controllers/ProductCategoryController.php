...
class ProductCategoryController extends Controller
{
    ...
    public function behaviors()
    {
      ...
      foreach ( $userGroupArray as $uGId => $uGName ){
          $permission = UserPermission::find()->where(['controller' => 'ProductCategory'])->andWhere(['user_group_id' => $uGId ] )->all();
          $actionArray = [];
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate() ) {
            ...
            $model->save();
            Yii::$app->session->setFlash('success', "Category has been created");
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', "Category has been deleted");
